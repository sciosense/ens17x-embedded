...
static inline int8_t ScioSense_Arduino_Spi_Read(void *config,
                                                const uint16_t address,
                                                uint8_t *data,
                                                const size_t size) {
  ScioSense_Arduino_Ens16x_Spi_Config *_config =
      ((ScioSense_Arduino_Ens16x_Spi_Config *)config);
...
static inline int8_t ScioSense_Arduino_Spi_Write(void *config,
                                                 const uint16_t address,
                                                 uint8_t *data,
                                                 const size_t size) {
  ScioSense_Arduino_Ens16x_Spi_Config *_config =
...
static inline void ScioSense_Arduino_Spi_Wait(uint32_t ms) { delay(ms); }
